 ...
 */
uint8_t __not_in_flash_func(dsp_gethyst)(int16_t *oldval, int16_t newval)
{
	uint8_t flag = 0;
 ...
 */
uint8_t __not_in_flash_func(dsp_ratio_hyst_arb)(uint16_t *old, uint16_t in, uint8_t range)
{
	uint8_t result = 0;
