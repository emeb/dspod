...
#define ST7789_CS_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define ST7789_CS_GPIO_PORT GPIOA
#define ST7789_CS_PIN GPIO_PIN_15

#define ST7789_DC_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
#define ST7789_DC_GPIO_PORT GPIOC
#define ST7789_DC_PIN GPIO_PIN_11

#define ST7789_RST_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
#define ST7789_RST_GPIO_PORT GPIOC
#define ST7789_RST_PIN GPIO_PIN_9

#define ST7789_BL_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
...
void ST7789_drawPixel(int16_t x, int16_t y, uint16_t color)
{
	...
	Shared_SPI_WriteHalfWord(color);
	...
	uint16_t color)
{
	...
	Shared_SPI_Blocking_PIO_WriteHalfWord(color, h*w);
