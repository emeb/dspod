 ...
 */
void __attribute__ ((section (".itcm_code"))) set_ifilter_mg4(ifmg4_state *f, int16_t fc, int16_t res, uint8_t bypass)
{
	int32_t ifc, ires;
 ...
 */
void __attribute__ ((section (".itcm_code"))) dupe_ifilter_mg4(ifmg4_state *f1, ifmg4_state *f2)
{
	f2->q = f1->q;
	f2->p = f1->p;
	f2->f = f1->f;
 ...
 */
int16_t __attribute__ ((section (".itcm_code"))) ifilter_mg4(ifmg4_state *f, int16_t input)
{
	int32_t in, out;
