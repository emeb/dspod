/*
 * main.c - dspod_h7r3 xspi flash test
 * 12-05-25 E. Brombaugh
 ******************************************************************************
 * Changelog
 *
 * date: 2025-12-05 V0.0
 * Initial creation
 *
 */
...
int main(void)
{
	...
	xspi_init(XSPI_FLASH_TYPE);
	printf("XSPI initialized\n\r");
	printf("Testing XSPI access to QSPI Flash...\n\r");
	printf("MFG/DEV ID - Result = %d\n\r", xspi_flash_test(0x1));
	printf("Read - Result = %d\n\r", xspi_flash_test(0x4));
	printf("Erase - Result = %d\n\r", xspi_flash_test(0x8));
	printf("Read - Result = %d\n\r", xspi_flash_test(0x4));
	printf("Write - Result = %d\n\r", xspi_flash_test(0x2));
	printf("Read - Result = %d\n\r", xspi_flash_test(0x4));
	printf("MMRd - Result = %d\n\r", xspi_flash_test(0x10));
	printf("Read - Result = %d\n\r", xspi_flash_test(0x4));
